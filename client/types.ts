...
export type View = 'dashboard' | 'tech-accelerator' | 'study-plan' | 'early-warning' | 'skill-gap' | 'mentor' | 'projects' | 'interview' | 'trends' | 'timetable' | 'lab' | 'peers' | 'notes' | 'parents' | 'scholar';
